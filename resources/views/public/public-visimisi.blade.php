...
<div class="blog-page area-padding">
    <div class="container">
        ...
        <!-- End left sidebar -->
        <!-- Start single blog -->
            <div class="col-md-7 col-sm-6 col-xs-12" style="padding: 4rem;">
                <div style="height: 100%">
                    <img src="{{ asset('assets/img/uptd/10.jpg') }}" alt="" style="max-width: 90%; border-radius: 1rem; box-shadow: .5rem .5rem 5rem rgba(0,0,0,.5); position: sticky; top: 0px;">
                </div>
            </div>
            <div class="col-md-5 col-sm-6 col-xs-12" style="padding: 2rem 0;">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                    <!-- single-blog start -->
