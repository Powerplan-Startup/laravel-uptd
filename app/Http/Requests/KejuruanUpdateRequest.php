...
class KejuruanUpdateRequest extends FormRequest
{
    ...
    {
        $id = $this->route('kejuruan')->id_kejuruan;
        return [
            'nama_kejuruan' => 'required|string|max:30|unique:kejuruan,nama_kejuruan,'.$id.',id_kejuruan',
